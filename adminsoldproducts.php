                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="adminsoldproducts.php" class="mm-active">
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center ">No.of Items Sold</th>
                                    ...
                                    ?>
                                        ...
                                        $allsoldrs = Database::search("SELECT * FROM `invoice` ORDER BY `date` DESC LIMIT " . $results_per_page . " OFFSET " . $page_first_result . "");
                                        $allnsold = $allsoldrs->num_rows;

                                      
                                        $c = "0";

                                        while ($allsold = $allsoldrs->fetch_assoc()) {

                                            $selectedrs = Database::search("SELECT * FROM `product`WHERE `id` ='".$allsold["product_id"]."' ");
                                        ...
                                        ?>
                                            ...
                                            <div class="col-12  mb-2">
                                                <div class="row" style="cursor: pointer;">
                                                    ...
                                                    <div class="col-2 col-lg-1 bg-dark pt-2 pb-2 text-end" onclick="singleviewmodal('<?php echo $srow['id']; ?>');">
                                                    ...
                                                    <div class="col-6 col-lg-2 bg-success pt-2 pb-2 " onclick="singleviewmodal('<?php echo $srow['id']; ?>');">
                                                        <span class="fs-5 fw-bold  text-white"><?php echo $srow["title"]; ?></span>
                                                    </div>
                                                    <div class="col-2 col-lg-2 bg-light pt-2 pb-2 d-none d-lg-block">
                                                        <span class="fs-5 fw-bold"><?php echo $sold["total"]; ?></span>
                                                    </div>
                                                    <div class="col-2 bg-success pt-2 pb-2 d-none d-lg-block">
                                                        <span class="fs-5 fw-bold text-white"><?php echo $sold["qty"]; ?></span>
                                                    </div>
